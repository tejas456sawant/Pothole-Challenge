      ...
      <View style={styles.endWrapperFillerRow}>
        ...
        <View style={styles.materialButtonVioletRow}>
          <SignInButton
            ...
            onPress={this.checkData}></SignInButton>
          <SignUpButton style={styles.materialButtonViolet}></SignUpButton>
        </View>
      </View>
    );
  }
        ...
        <View style={styles.contain1}>
          <View style={styles.materialIconTextboxColumn}>
            <MaterialIconTextbox
              ...
              autoCompleteType={'email'}></MaterialIconTextbox>
            <MaterialIconTextbox
